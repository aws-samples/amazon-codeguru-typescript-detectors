...
var express = require('express')
    ...
    function headerInjectionNoncompliant() {
        app.get("www.example.com", function (req: { query: { type: any } }, res: { setHeader: (arg0: string, arg1: any) => void }) {
...
var express = require('express')
    ...
    function headerInjectionCompliant() {
        app.get("www.example.com", function (req: any, res: { setHeader: (arg0: string, arg1: string) => void }) {
